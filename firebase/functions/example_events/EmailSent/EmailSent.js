...
class EmailSent extends Base {
  ...
  constructor ({ bypassCheck = false, type = "example.email.sent", source = "functions/email", time = null, data = null, id = null, specversion = "0.3" } = {}) {
    // EmailSent - a model defined in Cloud Events Generator
    //
    // Param type: The type of this EmailSent.
    // Type of type: String
    // Param source: The source of this EmailSent.
    // Type of source: String
    // Param time: The time of this EmailSent.
    // Type of time: String
    // Param data: The data of this EmailSent.
    // Type of data: Data
    // Param id: The id of this EmailSent.
    // Type of id: String
    // Param specversion: The specversion of this EmailSent.
  ...
  get type () {
    // Gets the type of this EmailSent.
    // returns: type
    // returnType: String
  ...
  set type (type) {
    // Sets the type of this EmailSent.
    // returns: undefined
    // returnType: undefined

    const allowedValues = ["example.email.sent"]
  ...
  get source () {
    // Gets the source of this EmailSent.
    // returns: source
    // returnType: String
  ...
  set source (source) {
    // Sets the source of this EmailSent.
    // returns: undefined
    // returnType: undefined

    const allowedValues = ["functions/email"]
  ...
  get time () {
    // Gets the time of this EmailSent.
    // returns: time
    // returnType: String
  ...
  set time (time) {
    // Sets the time of this EmailSent.
    // returns: undefined
    // returnType: undefined
  ...
  get data () {
    // Gets the data of this EmailSent.
    // returns: data
    // returnType: Data
  ...
  set data (data) {
    // Sets the data of this EmailSent.
    // returns: undefined
    // returnType: undefined
  ...
  get specversion () {
    // Gets the specversion of this EmailSent.
    // returns: specversion
    // returnType: String
  ...
  set specversion (specversion) {
    // Sets the specversion of this EmailSent.
    // returns: undefined
    // returnType: undefined
